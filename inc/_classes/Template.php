...
class Template {
    ...
    public function get_avatar($id = 0, $gender = '', $size = 0, $thumb = false, $class = '') {
        $id_f       = ($id ? $id : ($gender ? ($gender == 'male' ? rand(1, 8) : rand(9, 16)) : rand(1, 16)));
        $class_f    = '';
    ...
    public function get_tag($print = true, $status = false) {
        // Tag seed data
        $data = array(
            '0' => array('class' => 'success', 'text'  => 'Nueva'),
            '1' => array('class' => 'success', 'text'  => 'Nueva'),
            '2' => array('class' => 'success', 'text'  => 'Nueva'),
            '3' => array('class' => 'success', 'text'  => 'Nueva'),
            '4' => array('class' => 'success', 'text'  => 'Nueva'),
            '5' => array('class' => 'success', 'text'  => 'Completed'),
            '6' => array('class' => 'success', 'text'  => 'Processing'),
